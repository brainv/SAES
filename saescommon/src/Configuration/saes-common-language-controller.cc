...
SAESCommonLanguageController::SAESCommonLanguageController()
{
}
...
string SAESCommonLanguageController::getPackageName()
{
	return GETTEXT_PACKAGE;
}	

string SAESCommonLanguageController::getLocaleDir()
{
