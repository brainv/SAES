...
#ifndef _SAES_LANGUAGE_CONTROLLER_H_
#define _SAES_LANGUAGE_CONTROLLER_H_
...
namespace Smartmatic
{
	namespace SAES
	{
		...
		{
			/**
			 * @brief	Saes language controller. 
			 *
			 * @author	Eduardo.campione
			 * @date	28/04/2011
			 */

			class SAESLanguageController: public Smartmatic::Environment::BaseLanguageController
			{
			public:
			...
			virtual ~SAESLanguageController();
...
#endif // _SAES_LANGUAGE_CONTROLLER_H_
