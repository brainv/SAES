...
#ifndef _FLASH_DIAGNOSIS_FUNCTIONALITY_H_
#define _FLASH_DIAGNOSIS_FUNCTIONALITY_H_
...
namespace Smartmatic
{
	namespace SAES
	{
		namespace GUI
		{
			...
			{
				class FlashDiagnosisFunctionality: public GraphicDisplayFunctionality<Smartmatic::Functionality::MenuOptionDescriptor>
				{
				...
				public:
					...
					static FlashDiagnosisFunctionality* Current();
				...
				private:
					...
					static FlashDiagnosisFunctionality *current_instance;   ///< The current instance
					...
					sigc::connection connFlashDiag; ///< connection flash diagnosis
...
#endif // _FLASH_DIAGNOSIS_FUNCTIONALITY_H_
