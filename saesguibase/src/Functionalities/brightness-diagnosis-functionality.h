...
#ifndef _BRIGHTNESS_DIAGNOSIS_FUNCTIONALITY_H_
#define _BRIGHTNESS_DIAGNOSIS_FUNCTIONALITY_H_
...
namespace Smartmatic
{
	namespace SAES
	{
		namespace GUI
		{
			...
			{
				class BrightnessDiagnosisFunctionality: public GraphicDisplayFunctionality<Smartmatic::Functionality::MenuOptionDescriptor>
				{
				...
				public:
					...
					static BrightnessDiagnosisFunctionality* Current();
				...
				private:
					...
					static BrightnessDiagnosisFunctionality *current_instance;  ///< The current instance
					...
					BrightnessDiagnosisFunctionality();
...
#endif // _BRIGHTNESS_DIAGNOSIS_FUNCTIONALITY_H_
