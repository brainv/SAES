...
/*
 * voting-experience-validation-functionality.h
 *
 *  Created on: Apr 6, 2011
 *      Author: Gerardo Hernandez
 */

#ifndef _CHANGE_LANGUAGE_FUNCTIONALITY_H_
#define _CHANGE_LANGUAGE_FUNCTIONALITY_H_
...
namespace Smartmatic
{
	namespace SAES
	{
		namespace GUI
		{
			...
			{
				class ChangeLanguageFunctionality : public GraphicDisplayFunctionality<Smartmatic::Functionality::MenuOptionDescriptor>
				{
				public:
					...
					static ChangeLanguageFunctionality* Current();
				...
				private:
					...
					Smartmatic::SAES::GUI::Widgets::ChangeLanguageWidget* changeLanguageWidget; ///< The change language widget
					...
					static ChangeLanguageFunctionality *current_instance;   ///< The current instance
					...
					/**
					 * @brief	Executes the language change action.
					 *
					 * @author	Luiggi.mendez
					 * @date	28/04/2011
					 */
...
#endif // _CHANGE_LANGUAGE_FUNCTIONALITY_H_
