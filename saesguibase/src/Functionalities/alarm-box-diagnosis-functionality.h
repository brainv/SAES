...
#ifndef _ALARM_BOX_DIAGNOSIS_FUNCTIONALITY_H_
#define _ALARM_BOX_DIAGNOSIS_FUNCTIONALITY_H_
...
namespace Smartmatic
{
	namespace SAES
	{
		namespace GUI
		{
			...
			{
				class AlarmBoxDiagnosisFunctionality: public GraphicDisplayFunctionality<Smartmatic::Functionality::MenuOptionDescriptor>
				{
				...
				public:
					...
					static AlarmBoxDiagnosisFunctionality* Current();
				...
				private:
					...
					sigc::connection connFinishDiagnosis;	///< The connection finish diagnosis
					static AlarmBoxDiagnosisFunctionality *current_instance;	///< The current instance
					...
					AlarmBoxDiagnosisFunctionality();
...
#endif // _ALARM_BOX_DIAGNOSIS_FUNCTIONALITY_H_
