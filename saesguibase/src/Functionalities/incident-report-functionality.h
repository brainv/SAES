...
#ifndef _INCIDENT_REPORT_FUNCTIONALITY_H_
#define _INCIDENT_REPORT_FUNCTIONALITY_H_

#include <gtkmm.h>
#include <iostream>
#include <string.h>
#include <Functionalities/menu-option-descriptor.h>
#include "Gui/Widgets/Voting/PBReports/incident-report-widget.h"
...
namespace Smartmatic
{
	namespace SAES
	{
		namespace GUI
		{
			...
			{
				class IncidentReportFunctionality: public GraphicDisplayFunctionality<Smartmatic::Functionality::MenuOptionDescriptor>
				{
				...
				public:
					...
					static IncidentReportFunctionality* Current();
				...
				private:
					Smartmatic::SAES::GUI::Widgets::Voting::PBReports::IncidentReportWidget* incidentReportWidget;  ///< The incident report widget
					
					static IncidentReportFunctionality *current_instance;   ///< The current instance
...
#endif // _INCIDENT_REPORT_FUNCTIONALITY_H_
