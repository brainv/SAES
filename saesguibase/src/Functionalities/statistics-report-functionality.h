...
#ifndef _STATISTICS_REPORT_FUNCTIONALITY_H_
#define _STATISTICS_REPORT_FUNCTIONALITY_H_
...
namespace Smartmatic
{
	namespace SAES
	{
		namespace GUI
		{
			...
			{
				class StatisticsReportFunctionality: public GraphicDisplayFunctionality<Smartmatic::Functionality::MenuOptionDescriptor>
				{
				...
				public:
					...
					static StatisticsReportFunctionality* Current();
				...
				private:
					static StatisticsReportFunctionality *current_instance; ///< The current instance

					Smartmatic::SAES::GUI::Widgets::Voting::PBReports::StatisticCounterRegisterWidget* statisticCounterRegisterWidget;
...
#endif // _STATISTICS_REPORT_FUNCTIONALITY_H_
