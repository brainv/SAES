...
#ifndef _CLOSE_ELECTION_STATUS_WIDGET_H_
#define _CLOSE_ELECTION_STATUS_WIDGET_H_
...
namespace Smartmatic
{
	...
	namespace SAES
	{
		namespace GUI
		{
			...
			{
				/**
				 * @class	CloseElectionStatusWidget
				 *
				...
				class CloseElectionStatusWidget: public Smartmatic::GUI::Widgets::WizardWidgetBase
				{
				public:

					/**
					 * @fn	CloseElectionStatusWidget::CloseElectionStatusWidget();
					 *
					...
					CloseElectionStatusWidget(ProgressWidget * progress);
					...
					/**
					 * @fn	Glib::ustring CloseElectionStatusWidget::GetWidgetName()
					 *
...
#endif // _CLOSE_ELECTION_STATUS_WIDGET_H_
