...
SAESFunctionalityLanguageController::SAESFunctionalityLanguageController()
{
...
string SAESFunctionalityLanguageController::getPackageName()
{
	return GETTEXT_PACKAGE;
}

string SAESFunctionalityLanguageController::getLocaleDir()
{
