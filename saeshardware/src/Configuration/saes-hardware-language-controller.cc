...
SAESHardwareLanguageController::SAESHardwareLanguageController()
{
...
string SAESHardwareLanguageController::getPackageName()
{
	return GETTEXT_PACKAGE;
}

string SAESHardwareLanguageController::getLocaleDir()
{
