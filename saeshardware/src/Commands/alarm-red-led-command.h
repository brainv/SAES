/**
 * @file	alarm-red-led-command.h
 *
 * @brief	Declares the alarm red led command class.
 */
...
#ifndef _ALARM_RED_LED_COMMAND_H_
#define _ALARM_RED_LED_COMMAND_H_
...
namespace Smartmatic
{
	namespace SAES
	{
		namespace HW
		{
			...
			{
				/**
				 * @brief	Manages the commands that control the red led of the alarm.
				 *
				 * @author	Fsilva
				 * @date	28/04/2011
				 */

				class AlarmRedLedCommand: public CommandBaseAlarm
				{
				...
				AlarmRedLedCommand(unsigned char period, unsigned char repeat);
...
#endif // _ALARM_RED_LED_COMMAND_H_
